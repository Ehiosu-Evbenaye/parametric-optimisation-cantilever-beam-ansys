...
## Project Roadmap
- **1**: Complete all analytical sections (done)
- **2**: Install ANSYS Student → rebuild baseline model
- **3**: Set up parametric taper in SpaceClaim
- **4**: Run DesignXplorer optimisation
- **5**: Post-processing, verification, and final report
